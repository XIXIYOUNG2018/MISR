...
#datasets=(ROA )
# datasets=(NR-AhR EC)
# datasets=(T12 BBB CYP2C19-inh NR-AR NR-ER-LBD NR-Aromatase FDAMDD NR-AhR EC F30% F20% Pgp-sub Pgp-inh CYP2C9-sub CYP1A2-inh SkinSen CYP2D6-inh CYP2D6-sub DILI Ames CYP2C19-sub)
# datasets=(F30%  F20%)
# datasets=(HIA FDAMDD)
# datasets=(EI)
...
# datasets=(CYP3A4-sub CYP2C9-inh H-HT CYP3A4-inh CYP1A2-sub Respiratory hERG Carcinogenicity)
...
#do
#echo $element
python ../../graphormer/entry_clf.py --num_workers 4 --seed $seed --batch_size $batch_size \
      --dataset_name hERG_smi    --checkpoint_path /home/ps/Documents/xxy/pred/Admethormer_finetune/exps/pretrain/mask/last.ckpt\
