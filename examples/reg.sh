...
max_epochs=20
python ../../models/entry.py --num_workers 4 --seed $seed --batch_size $batch_size \
      --dataset_name LogD_smi    --checkpoint_path /home/ps/Documents/xxy/pred/MISR/exps/pretrain/mask/last.ckpt\
