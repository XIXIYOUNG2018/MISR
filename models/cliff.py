...
from model_cliff import Graphormer
...
def cli_main():
    ...
    if args.test:
        ...
        trainer.fit(model, datamodule=dm)
                   #ckpt_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/exps/cliff/CHEMBL1871_Ki/1/lightning_logs/checkpoints/last.ckpt')
