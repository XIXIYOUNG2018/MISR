...
reg_root_file='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/csv/reg/'
reg_files=os.listdir(reg_root_file)
clf_root_file='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/csv/clf/'
...
data=pd.read_csv('/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/chembl/chembl.csv')

smiles_list.extend(list(data['smiles'])) # get smiles strings from file
...
def mol_to_graph(mol,y,task,task_num,smiles):
    """
...
for file in [reg_files[0]]:
    path=os.path.join(reg_root_file+file)
    print(path)
    ...
    for i in range(len(smiles_list)):
        try:
            ...
            if mol!=None:
                graph_object, no_bond_flag = mol_to_graph(mol,label[i],0,task_num,smiles_list[i])       
        except:
            continue
        if no_bond_flag:
            continue
    ...
    train_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+columns[2]+'train.pickle'
    test_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+columns[2]+'test.pickle'
    val_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+columns[2]+'val.pickle'
...
# train_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'train_reg.pickle'
# test_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'test_reg.pickle'
# val_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'val_reg.pickle'
# with open(train_path,'wb') as f:
#     pickle.dump(train,f)
# with open(val_path,'wb') as f:
#     pickle.dump(val,f)
...
print(clf_files[-1])
#####load  clf data set#####
for file in [clf_files[10]]:
    path=os.path.join(clf_root_file+file)
    print(path)
    data=pd.read_csv(path)
    smiles_list=data['smiles']
    columns=data.columns
    label=data[columns[2]]
    task_num=clf_task.index(file[:-4])
    graph=[]
    for i in range(len(smiles_list)):
        try:
            mol=Chem.MolFromSmiles(smiles_list[i])
            if mol!=None:
                graph_object, no_bond_flag = mol_to_graph(mol,label[i],1,task_num,smiles_list[i])       
        except:
            continue
        if no_bond_flag:
            continue
    ...
    train_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+file[:-4]+'train.pickle'
    test_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+file[:-4]+'test.pickle'
    val_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/'+file[:-4]+'val.pickle'
    with open(train_path,'wb') as f:
        pickle.dump(train_mol,f)
    with open(val_path,'wb') as f:
        pickle.dump(val_mol,f)
...
train_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'train_clf.pickle'
test_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'test_clf.pickle'
val_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'val_clf.pickle'
with open(train_path,'wb') as f:
    pickle.dump(train,f)
with open(val_path,'wb') as f:
    pickle.dump(val,f)
...
train_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'train_all.pickle'
test_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'test_all.pickle'
val_path='/home/ps/Documents/xxy/pred/Admethormer_finetune/dataset/admet/pickle/all/'+'val_all.pickle'
with open(train_path,'wb') as f:
    pickle.dump(x,f)
with open(val_path,'wb') as f:
    pickle.dump(y,f)
