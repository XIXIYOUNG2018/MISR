...
# f1=open('emb_h1_reg.pkl','ab')
# f2=open('emb_h2_reg.pkl','ab')
# f3=open('pred.pkl','ab')
# g1=open('y.pkl','ab')
# file=open('smiles.pkl','ab')
# g=open('node_seq.pkl','ab')
# g2=open('clf_weight.pkl','ab')
# g3=open('bg_train.pkl','ab')
import pickle
class Multi_Task(nn.Module):
    ...
    def forward(self,batched_data, feats, norm=None):
        ...
        # pickle.dump(feats.to('cpu').numpy(),g)
        ...
        # w=atom_weight_list[7]
        # w=w.to('cpu').numpy()
        # pickle.dump(w,g2)
        # atom=batched_data.x
        # pickle.dump(atom.to('cpu').numpy(),g)
        # pickle.dump(batched_data.smiles,file)
        # pickle.dump(batched_data.y.to('cpu').numpy(),g1)
